...
@section('content')
    ...
    <section class="page-banner-area overlay py-170 rpy-120 rel z-1 bgs-cover text-center"
        style="background-image: url({{ $event->main_image_url ?? asset('public/assets/images/background/banner-two.jpg') }})">
        <div class="container">
            ...
            <div class="row gap-70">
                <div class="col-lg-12">
                    <div class="blog-details-image" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <img src="{{ $event->image_card_url ?? asset('public/metronic/assets/media/users/blank.png') }}"
                            alt="Event Details" />
                    </div>
