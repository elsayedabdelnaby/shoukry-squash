    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item {{ request()->routeIs('dashboard.courts.*') ? 'menu-item-active' : null }}"
                    aria-haspopup="true">
                    <a href="{{ route('dashboard.courts.index') }}" class="menu-link">
                        <i class="menu-bullet menu-bullet-line">
                            <span></span>
                        </i>
                        <span class="menu-text">{{ __('dashboard.courts') }}</span>
                    </a>
                </li>
                ...
                <li class="menu-item {{ request()->routeIs('dashboard.packages.*') ? 'menu-item-active' : null }}"
                    aria-haspopup="true">
                    <a href="{{ route('dashboard.packages.index') }}" class="menu-link">
                        <i class="menu-bullet menu-bullet-line">
                            <span></span>
                        </i>
                        <span class="menu-text">{{ __('dashboard.packages') }}</span>
                    </a>
                </li>
                ...
                <li class="menu-item {{ request()->routeIs('dashboard.missions.*') ? 'menu-item-active' : null }}"
                    aria-haspopup="true">
                    <a href="{{ route('dashboard.missions.index') }}" class="menu-link">
                        <i class="menu-bullet menu-bullet-line">
                            <span></span>
                        </i>
                        <span class="menu-text">{{ __('dashboard.missions') }}</span>
                    </a>
                </li>


                <li class="menu-item {{ request()->routeIs('dashboard.objectives.*') ? 'menu-item-active' : null }}"
                    aria-haspopup="true">
                    <a href="{{ route('dashboard.objectives.index') }}" class="menu-link">
                        <i class="menu-bullet menu-bullet-line">
                            <span></span>
                        </i>
                        <span class="menu-text">{{ __('dashboard.objectives') }}</span>
                    </a>
                </li>
                ...
                <li class="menu-item {{ request()->routeIs('dashboard.salary-report') ? 'menu-item-active' : null }}"
                    ...
                    <a href="{{ route('dashboard.salary-report') }}" class="menu-link">
                        ...
                        <span class="menu-text">{{ __('dashboard.salary_report') }}</span>
                    </a>
                </li>
                <li class="menu-item {{ request()->routeIs('dashboard.checkinouts') ? 'menu-item-active' : null }}"
                    aria-haspopup="true">
                    <a href="{{ route('dashboard.checkinouts') }}" class="menu-link">
                        <i class="menu-bullet menu-bullet-line">
                            <span></span>
                        </i>
                        <span class="menu-text">{{ __('dashboard.checkinouts') }}</span>
                    </a>
                </li>

                <li class="menu-item {{ request()->routeIs('dashboard.employees.*') ? 'menu-item-active' : null }}"
                    aria-haspopup="true">
                ...
                <li class="menu-item {{ request()->routeIs('dashboard.departments.*') ? 'menu-item-active' : null }}"
                    aria-haspopup="true">
                    <a href="{{ route('dashboard.departments.index') }}" class="menu-link">
                        <i class="menu-bullet menu-bullet-line">
                            <span></span>
                        </i>
                        <span class="menu-text">{{ __('dashboard.departments') }}</span>
                    </a>
                </li>

                <li class="menu-item {{ request()->routeIs('dashboard.jobs.*') ? 'menu-item-active' : null }}"
                    aria-haspopup="true">
                    <a href="{{ route('dashboard.jobs.index') }}" class="menu-link">
                        <i class="menu-bullet menu-bullet-line">
                            <span></span>
                        </i>
                        <span class="menu-text">{{ __('dashboard.jobs') }}</span>
                    </a>
                </li> --}}
