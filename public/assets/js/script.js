/*-----------------------------------------------------------------------------------
    Template Name: Shoukry - Squash Template Template
    Template URI: https://thecoderland.com/
    Author: Ahmed Ali Mohamed
    Author URI:  https://thecoderland.com/cv.pdf
    Version: 1.0
  ...
  $(document).ready(function () {
    ...
    if ($(".main-header .navigation li.dropdown ul").length) {
      $(".main-header .navigation li.dropdown").append(
        '<div class="dropdown-btn"><span class="far fa-angle-down"></span></div>'
      );
    ...
    if ($(".testimonials-five-active").length) {
      $(".testimonials-five-active").slick({
        ...
        autoplaySpeed: 5000,
        prevArrow:
          '<button class="prev-arrow"><i class="far fa-angle-double-left"></i></button>',
        nextArrow:
          '<button class="next-arrow"><i class="far fa-angle-double-right"></i></button>',
      });
    }
        ...
        progressThree.appear(function () {
          progressThree
            ...
            .on("circle-animation-progress", function (event, progress) {
              $(this)
                .find(".counting")
                .html(Math.round(24 * progress) + "<span>H</span>");
            });
        });
      }
    }
